...
namespace FileUtils
{
     ...
     */
    static std::string getSearchPath(const std::string & dirPath)
    {
    #ifdef _WIN32
    ...
    ///
    static bool getFileLines(const std::string &filePath,
    ...
    ///
    static void getFileContents(const std::string &filePath, std::string &data)
    {
     ...
     * @param dataOut
     */
    static void getRawFileContents(const std::string &filePath, std::vector<char> &dataOut)
    {
        size_t length;
		FILE * rawFilePtr;
		fopen_s(&rawFilePtr,filePath.c_str(), "rb");
        if (rawFilePtr)
        {
    ...
    ///
    static bool writeFileContents(const std::string &filePath,
     ...
     */
    static bool openBinaryFileForWrite(const std::string &filePath,
                                           std::ofstream &out)
    {
     ...
     * @return Returns true if the file was opened, false otherwise
     */
    static bool openBinaryFileForRead(const std::string &filePath,
                                          std::ifstream &in)
    {
     ...
     * @return Returns true if the file was opened, false otherwise
     */
    static bool openTextFileForRead(const std::string &filePath,
                                    std::ifstream &in)
    {
     ...
     * @return Returns true if the file was opened, false otherwise
     */
    static bool openTextFileForWrite(const std::string &filePath,
                                         std::ofstream &out)
    {
     ...
     */
    static std::string buildFilePath(const std::string &dirPath, const std::string &fileName)
    {
    ...
    #   endif
        ...
        size_t fileHasSep=
                StringUtils::startsWith(StringUtils::trimmed(file),pathSep);
     ...
     */
    static void getFileEntries(const std::string &dirPath,
                               bool keepFullPath,
     ...
     */
    static void getRecursiveFolders(const std::string & dirPath,
     ...
     * @param entryListOut
     */
    static void getRecursiveFileEntries(const std::string &dirPath,
     ...
     * @return
     */
    static std::vector<std::string> getRecursiveFileEntries(const std::string &dirPath,
    ...
    static std::uint64_t getFileSize(const std::string &filePath)
    {
     ...
     */
    static void writeRawContentsToFile(const std::string & filePath,const char * buffer, size_t bufferSize)
    {
     ...
     * @param newFilePath
     */
    static void renameFile(const std::string &oldFilePath, const std::string &newFilePath)
    {
    ...
    {
        Random rnd;
        rnd.reseed(static_cast<unsigned long>(TimeUtils::getMicrosecondsNow() + TimeUtils::getSecondsNow()));
        std::string file;
     ...
     * @return
     */
    static std::string getRandomFileName(int length, int extensionLength)
    {
        Random rnd;
        rnd.reseed(static_cast<unsigned long>(TimeUtils::getMicrosecondsNow() + TimeUtils::getSecondsNow()));
     ...
     * @return
     */
    static int deleteFolder(const std::string &dirPath)
    {
     ...
     * @return
     */
    static std::vector<std::string> getFolderEntries(const std::string& dirPath,
                                                     bool fullPath = true)
    {
        std::vector<std::string> folders;
        getFileEntries(dirPath,fullPath,{""},folders,true);
